...
python3 scripts/main.py --college-id 4 --type overview

# Generate fees content
python3 scripts/main.py --college-id 4 --type fees

# Generate reviews content
python3 scripts/main.py --college-id 4 --type reviews

# Generate courses content
python3 scripts/main.py --college-id 4 --type courses

# Generate campus content
python3 scripts/main.py --college-id 4 --type campus

# Generate short overview content
python3 scripts/main.py --college-id 4 --type overview_short

# Generate with AI validation
python3 scripts/main.py --college-id 4 --ai-validation

# Save content to database
python3 scripts/main.py --college-id 4 --save-to-db
python3 scripts/main.py --college-id 4 --save-to-tabs

# Override API key
python3 scripts/main.py --college-id 4 --api-key "your_key_here"
```
...
python3 scripts/generate_overviews_from.py --api-key "your_key_here"

# Generate with database saving
python3 scripts/generate_overviews_from.py --save-to-db

# Generate with AI validation
python3 scripts/generate_overviews_from.py --ai-validation --gptzero-api-key "your_key"

# Generate with both database saving and AI validation
python3 scripts/generate_overviews_from.py --save-to-db --ai-validation

# Process specific colleges
python3 scripts/generate_overviews_from.py --college-ids "1,4,5,10"

# Process with limits and offsets
python3 scripts/generate_overviews_from.py --limit 50 --offset 100

# Dry run to see what would be processed
python3 scripts/generate_overviews_from.py --dry-run --limit 10

# Start processing from a specific college ID with humanization retries
python3 scripts/generate_overviews_from.py --start-from 100 --limit 50 --save-to-db --ai-validation

# Process with custom retry attempts for AI scores >90%
python3 scripts/generate_overviews_from.py --start-from 1 --limit 10 --save-to-db --ai-validation --max-retries 3

# Process a range of colleges with humanization
python3 scripts/generate_overviews_from.py --start-from 100 --end-at 200 --save-to-db --ai-validation --max-retries 2

# Start from college ID 50 and process next 25 colleges
python3 scripts/generate_overviews_from.py --start-from 50 --limit 25 --delay 1.5
...
python3 scripts/generate_overview_short_from.py --start-from 1 --limit 10 --save-to-db --ai-validation

# Process overview_short with custom retry attempts for AI scores >90%
python3 scripts/generate_overview_short_from.py --start-from 1 --limit 10 --save-to-db --ai-validation --max-retries 3

# Process overview_short for a range of colleges with humanization
python3 scripts/generate_overview_short_from.py --start-from 100 --end-at 200 --save-to-db --ai-validation --max-retries 2

# Start from college ID 50 and process next 25 overview_short content
python3 scripts/generate_overview_short_from.py --start-from 50 --limit 25 --delay 1.5

# Dry run to see what would be processed for overview_short
python3 scripts/generate_overview_short_from.py --start-from 100 --limit 10 --dry-run

# Basic overview_short generation with all features
python3 scripts/generate_overview_short_from.py --start-from 1 --limit 100 --save-to-db --ai-validation --max-retries 3
```
...
python3 scripts/generate_courses_from.py --start-from 1 --limit 10 --save-to-db --ai-validation

# Process courses with custom retry attempts for AI scores >90%
python3 scripts/generate_courses_from.py --start-from 1 --limit 10 --save-to-db --ai-validation --max-retries 3

# Process courses for a range of colleges with humanization
python3 scripts/generate_courses_from.py --start-from 100 --end-at 200 --save-to-db --ai-validation --max-retries 2

# Start from college ID 50 and process next 25 courses content
python3 scripts/generate_courses_from.py --start-from 50 --limit 25 --delay 1.5

# Dry run to see what would be processed for courses
python3 scripts/generate_courses_from.py --start-from 100 --limit 10 --dry-run

# Basic courses generation with all features
python3 scripts/generate_courses_from.py --start-from 1 --limit 100 --save-to-db --ai-validation --max-retries 3
```
...
python3 scripts/generate_course_short_from.py --start-from 1 --limit 10 --save-to-db --ai-validation

# Process course_short with custom retry attempts for AI scores >90%
python3 scripts/generate_course_short_from.py --start-from 1 --limit 10 --save-to-db --ai-validation --max-retries 3

# Process course_short for a range of colleges with humanization
python3 scripts/generate_course_short_from.py --start-from 100 --end-at 200 --save-to-db --ai-validation --max-retries 2

# Start from college ID 50 and process next 25 course_short content
python3 scripts/generate_course_short_from.py --start-from 50 --limit 25 --delay 1.5

# Dry run to see what would be processed for course_short
python3 scripts/generate_course_short_from.py --start-from 100 --limit 10 --dry-run
...
python3 scripts/run_all_tabs.py --college-id 4

# Generate all tabs with AI validation
python3 scripts/run_all_tabs.py --college-id 4 --ai-validation
```
...
python3 scripts/generate_courses_from.py --start-from 1 --limit 1000 --save-to-db --ai-validation --max-retries 3 --delay 2.0

# Full course_short generation with all features
python3 scripts/generate_course_short_from.py --start-from 1 --limit 1000 --save-to-db --ai-validation --max-retries 3 --delay 2.0
```
...
python3 scripts/generate_overviews_from.py --start-from 1 --limit 1 --save-to-db --ai-validation --max-retries 3

# Dry run to check processing range
python3 scripts/generate_overviews_from.py --start-from 100 --limit 10 --dry-run

# Test specific range
python3 scripts/generate_overviews_from.py --start-from 1 --end-at 5 --save-to-db --ai-validation
```
...
python3 scripts/generate_overviews_from.py --start-from 151 --limit 500 --save-to-db --ai-validation --max-retries 3

# Process specific problematic colleges
python3 scripts/generate_overviews_from.py --college-ids "45,67,89,123" --save-to-db --ai-validation --max-retries 5
```
